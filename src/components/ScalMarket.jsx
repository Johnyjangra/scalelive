...
<img className='w-100 carrier_img' src={carrier_img} alt="carrier_img" />
                ...
                <Col lg={4} md={10} xs={11} className='pe-0 pe-sm-2'>
                <p className='ff_rubik text-white fw-normal lh_150 opcity_09 fs_lg market_para position-relative mb-0 pt-md-4 mt-1 pt-3 pt-2'>From retailers, carriers, distributors, and repair shops to individual consumers, we cater to diverse needs, following a client-centric approach that puts your specific requirements in the spotlight.</p>
                </Col>
            </Row>
            <div className='position-relative bottom_p_lines mx-auto mt-5'>
                <div className='bg-black py-4'><p className='py-2 mt-1 ff_rubik text-white fw-normal lh_150 opcity_09 fs_md position-relative mx-auto mb-0 mw_685 text-center'>Browse our wide assortment of smartphones and services, find what responds to your demands, and let us do what we know best; offer you the most pleasant, smooth, and stress-free client experience.</p></div>
