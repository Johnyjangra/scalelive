      ...
      >
        ...
        <div className="position-relative mw_1440">
          <Container className="py-5 my-xl-5">
            <Row className="align-items-center justify-content-center justify-content-lg-between flex-column-reverse flex-lg-row">
              ...
              <Col xl={6} lg={6}className="ps-lg-5">
                <h4 className="ff_rubik fw-medium text-white fs_2xl mb-0">FAQs</h4>
                <div className="faqs">
                  <Accordion defaultActiveKey="0">
                    <Accordion.Item eventKey="0"data-aos="fade-up"data-aos-delay="1000">
                      ...
                      <Accordion.Body data-aos="fade-up"data-aos-delay="500">
                    ...
                    <Accordion.Item eventKey="1"data-aos="fade-up"data-aos-delay="700">
                      <Accordion.Header>
                    ...
                    <Accordion.Item eventKey="2"data-aos="fade-up"data-aos-delay="900">
                      <Accordion.Header>
                    ...
                    <Accordion.Item eventKey="3"data-aos="fade-up"data-aos-delay="1100">
                      <Accordion.Header>
                    ...
                    <Accordion.Item eventKey="4"data-aos="fade-up"data-aos-delay="1300">
                      <Accordion.Header>
                    ...
                    <Accordion.Item eventKey="5"data-aos="fade-up"data-aos-delay="1500">
                      <Accordion.Header>
